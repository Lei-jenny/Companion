      ...
      <div className="px-8 pt-8 pb-10 flex flex-col h-full">
        ...
        <div className="space-y-5 mb-8">
          <div className="group relative">
            ...
            <p className="text-[10px] text-slate-400 mt-1 ml-1">Key is only used for this session.</p>
          </div>
          <div className="group relative">
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5 ml-1">
              Image API Key
            ...
            <p className="text-[10px] text-slate-400 mt-1 ml-1">Used for image generation requests.</p>
          </div>
          <div className="group relative">
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5 ml-1">
              Order ID
